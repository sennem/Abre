<?php
    ...
    */
	...
	if(superadmin())
	{
		echo "<form id='form-mood-settings' method='post' enctype='multipart/form-data' action='modules/".basename(__DIR__)."/updatesettings.php'>";
			echo "<div class='mdl-shadow--2dp' style='background-color:#fff; padding:20px 40px 40px 40px'>";

					$query = "SELECT Certica_URL, Certica_AccessKey FROM mood_settings";
