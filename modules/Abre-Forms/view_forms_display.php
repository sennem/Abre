    ...
    */
	...
	if($_SESSION['usertype'] == "staff" || admin() || isFormsAdministrator())
	{
			...
			echo "<tr class='formsrow pointer'>";
					...
					echo "<div class='morebutton' style='position:relative;'>";
						...
						echo "<ul class='mdl-menu mdl-menu--bottom-right mdl-js-menu mdl-js-ripple-effect' for='demo-menu-bottom-left-$ID'>";
							...
							echo "<li class='mdl-menu__item deleteform' data-formid='$ID'>Delete</li>";
		...
		if($totalformscount == 0){
			echo "<div class='row' style='padding:56px; text-align:center; width:100%;'><span style='font-size: 22px; font-weight:700'>No Forms Found</span><br><p style='font-size:16px; margin:20px 0 0 0;'>Click the '+' in the bottom right to create a form.</p></div>";
		}
