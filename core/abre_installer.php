...
if (!file_exists('configuration.php'))
{
	if(isset($_POST["site_title"])!="" && $_POST["db_host"]!="" && $_POST["db_user"]!="" && $_POST["db_password"]!="" && $_POST["google_client_id"]!="" && $_POST["google_client_secret"]!="" && $_POST["google_api_key"]!="")
	{
		...
		$sql .= "CREATE TABLE `directory` (`id` int(11) NOT NULL,`updatedtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,`superadmin` int(11) NOT NULL,`admin` int(11) NOT NULL,`archived` int(11) NOT NULL,`picture` text NOT NULL,`firstname` text NOT NULL,`lastname` text NOT NULL,`middlename` text NOT NULL,`title` text NOT NULL,`address` text NOT NULL,`city` text NOT NULL,`state` text NOT NULL,`zip` text NOT NULL,`email` text NOT NULL,`phone` text NOT NULL,`cellphone` text NOT NULL,`gender` text NOT NULL,`ethnicity` text NOT NULL,`contract` text NOT NULL,`grade` text NOT NULL,`subject` text NOT NULL,`ss` text NOT NULL,`dob` text NOT NULL,`classification` text NOT NULL,`location` text NOT NULL,`doh` text NOT NULL,`senioritydate` text NOT NULL,`effectivedate` text NOT NULL,`step` text NOT NULL,`salary` text NOT NULL,`hours` text NOT NULL,`stateeducatorid` text NOT NULL,`licensetype1` text NOT NULL,`licenseissuedate1` text NOT NULL,`licenseexpirationdate1` text NOT NULL,`licenseterm1` text NOT NULL,`licensetype2` text NOT NULL,`licenseissuedate2` text NOT NULL,`licenseexpirationdate2` text NOT NULL,`licenseterm2` text NOT NULL,`licensetype3` text NOT NULL,`licenseissuedate3` text NOT NULL,`licenseexpirationdate3` text NOT NULL,`licenseterm3` text NOT NULL,`licensetype4` text NOT NULL,`licenseissuedate4` text NOT NULL,`licenseexpirationdate4` text NOT NULL,`licenseterm4` text NOT NULL,`licensetype5` text NOT NULL,`licenseissuedate5` text NOT NULL,`licenseexpirationdate5` text NOT NULL,`licenseterm5` text NOT NULL,`licensetype6` text NOT NULL,`licenseissuedate6` text NOT NULL,`licenseexpirationdate6` text NOT NULL,`licenseterm6` text NOT NULL,`probationreportdate` text NOT NULL,`statebackgroundcheck` text NOT NULL,`federalbackgroundcheck` text NOT NULL,`permissions` text NOT NULL,`contractdays` text NOT NULL) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=latin1;";
		$sql .= "ALTER TABLE `directory` ADD PRIMARY KEY (`id`);";
   		$sql .= "ALTER TABLE `directory` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;";
