	...
	if ($client->getAccessToken()){
		...
		echo "<div class='mdl-card__title'>";
			echo "<div class='valign-wrapper'>";
				echo "<a href='https://calendar.google.com' target='_blank'><img src='core/images/icon_calendar.png' class='icon_small'></a>";
				echo "<div><div class='mdl-card__title-text'>Calendar</div><div class='card-text-small'>Your Next 24 Hours</div></div>";
			echo "</div>";
		echo "</div>";
